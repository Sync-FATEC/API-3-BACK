...
public interface ProjectRepository extends JpaRepository<Project, String>, JpaSpecificationExecutor<Project> {
        ...
        @Query("SELECT p FROM Project p JOIN p.coordinators c JOIN p.company co WHERE " +
                        "(:projectReference IS NULL OR p.projectReference LIKE %:projectReference%) AND " +
                        "(:projectCompany IS NULL OR co.corporateName LIKE %:projectCompany%) AND " +
...
""")
        ...
        FROM Project p
        JOIN p.company co
        WHERE (:projectCompany IS NULL OR co.corporateName LIKE %:projectCompany%) AND
                  (:projectStartDate IS NULL OR p.projectStartDate >= :projectStartDate) AND
                  (:projectEndDate IS NULL OR p.projectEndDate <= :projectEndDate)
""")
        ...
        WHERE
                (:keyword IS NULL OR 
                        ...
                        co.corporateName LIKE %:keyword% OR
