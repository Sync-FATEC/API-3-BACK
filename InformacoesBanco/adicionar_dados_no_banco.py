...
def insert_projeto(cursor, data, seen_coordinators, seen_companies):
    ...
    cursor.execute(
        "INSERT INTO projects (project_id, coordinator_id, project_company, project_description, project_end_date, project_objective, project_reference, project_title, project_start_date, project_value, project_classification, project_status) VALUES (%s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s, %s)",
        (
            project_id,
            coordinator_id,
            company_name,
